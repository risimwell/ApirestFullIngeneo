...
export class EditComponent implements OnInit {
  ...
  constructor(private updateService: UpdateserviceService, private fb: FormBuilder, private router: Router) {}
  ...
  ngOnInit(): void {
    ...
    this.updateService.getDatosPersonales(this.userId).subscribe(
      response => {
        ...
        this.form.patchValue(this.datos); // Asignar los datos al formulario
      },
      error => {
